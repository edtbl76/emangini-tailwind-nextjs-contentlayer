...
- **KEEP** the transferable substance: the technique, the _why_ (decision rationale + tradeoffs), the gotchas and
...
- **⚠️ Check:** anything that _might_ still be lab-identifying, or that you were unsure whether to keep — flag it
